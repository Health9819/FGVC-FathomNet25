...
_DATA_CFG_DICT.FATHOM = CN()
_DATA_CFG_DICT.FATHOM.DATA = CN()
_DATA_CFG_DICT.FATHOM.DATA.NAME = "FATHOM"
_DATA_CFG_DICT.FATHOM.DATA.INPUT = CN()
_DATA_CFG_DICT.FATHOM.DATA.INPUT.SIZE_SCALE = 600,
_DATA_CFG_DICT.FATHOM.DATA.PATH = "data/fine-grained-data/Fathom"
